...
канонический краткий план поддерживается в `../testing/plan.md`.
...
`../testing/plan.md`, проверить `ruff`, применимый `mypy` и `git diff --check`.
...
- [x] **D0. Зафиксировать исследование и исполнимый план.**
  ...
  - Синхронизировать `../testing/plan.md` с этапами D0–P9 и включить
    views/admin.
